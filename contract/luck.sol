...
contract LuckyDragonNFT is ERC721Enumerable, Ownable {
    ...
    */
    ...
    modifier onlyAirdropWhitelisted() {
        require(airdropWhitelist[msg.sender], 'Sorry, this address is not on the airdrop whitelist. Please message us on Discord.');
        _;
    }
    ...
    /** Add multiple addresses to whitelist */
    function multipleAddressesToAirdropWhiteList(address[] memory addresses) public onlyOwner {
        for(uint256 i =0; i < addresses.length; i++) {
            singleAddressToAirdropWhiteList(addresses[i]);
        }
    }
    ...
    /** Add single address to airdropWhitelist */
    function singleAddressToAirdropWhiteList(address userAddress) public onlyOwner {
        require(userAddress != address(0), "Address can not be zero");
        airdropWhitelist[userAddress] = true;
        totalAirdropWhitelist++;
    }
    ...
    function removeAddressesFromWhiteList(address[] memory addresses) public onlyOwner {
     ...
     /** Remove multiple addresses from airdropWhitelist */
    function removeAddressesFromAirdropWhiteList(address[] memory addresses) public onlyOwner {
        for(uint i =0; i<addresses.length; i++) {
            removeAddressFromAirdropWhiteList(addresses[i]);
        }
    }
    ...
    function removeAddressFromWhiteList(address userAddress) public onlyOwner {
     ...
     /** Remove single address from airdropWhitelist */
    function removeAddressFromAirdropWhiteList(address userAddress) public onlyOwner {
        require(userAddress != address(0), "Address can not be zero");
        airdropWhitelist[userAddress] = false;
        totalAirdropWhitelist--;
    }
    ...
    function airDrop(address[] calldata m) public onlyOwner {
        ...
        require(supply < airdropSupply,                 'This transaction would exceed airdrop max supply');
